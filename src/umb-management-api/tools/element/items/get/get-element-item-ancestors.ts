import { getItemElementAncestorsQueryParams, getItemElementAncestorsResponse } from "@/umb-management-api/umbracoManagementAPI.zod.js";
import { GetItemElementAncestorsParams } from "@/umb-management-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
