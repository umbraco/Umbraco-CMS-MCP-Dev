import { UpdateStylesheetRequestModel } from "@/umbraco-api/schemas/index.js";
import { putStylesheetByPathParams, putStylesheetByPathBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
