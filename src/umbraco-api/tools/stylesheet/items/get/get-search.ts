import { GetItemStylesheetParams } from "@/umbraco-api/schemas/index.js";
import { getItemStylesheetQueryParams, getItemStylesheetResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
