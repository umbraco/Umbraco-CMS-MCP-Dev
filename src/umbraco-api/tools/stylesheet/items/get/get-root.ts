import { GetTreeStylesheetRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeStylesheetRootQueryParams, getTreeStylesheetRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
