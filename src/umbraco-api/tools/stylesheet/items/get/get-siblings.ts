import { GetTreeStylesheetSiblingsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeStylesheetSiblingsQueryParams, getTreeStylesheetSiblingsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
