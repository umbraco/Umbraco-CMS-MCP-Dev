import { putMediaTypeByIdMoveBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { MoveMediaTypeRequestModel } from "@/umbraco-api/schemas/moveMediaTypeRequestModel.js";
import { z } from "zod";
import {
  type ToolDefinition,
