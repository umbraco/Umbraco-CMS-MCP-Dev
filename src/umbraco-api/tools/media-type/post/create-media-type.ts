...
import { CreateMediaTypeRequestModel, ProblemDetails } from "@/umbraco-api/schemas/index.js";
import { postMediaTypeBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
  createToolResult,
