import { postMediaTypeAvailableCompositionsBody, postMediaTypeAvailableCompositionsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { MediaTypeCompositionRequestModel } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
