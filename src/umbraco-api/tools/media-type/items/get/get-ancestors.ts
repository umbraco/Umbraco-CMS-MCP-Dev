import { GetTreeMediaTypeAncestorsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMediaTypeAncestorsQueryParams, getTreeMediaTypeAncestorsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
