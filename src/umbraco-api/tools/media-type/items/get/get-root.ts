import { GetTreeMediaTypeRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMediaTypeRootQueryParams, getTreeMediaTypeRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
