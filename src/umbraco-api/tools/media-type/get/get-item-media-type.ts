import { getItemMediaTypeQueryParams, getItemMediaTypeResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetItemMediaTypeParams } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
