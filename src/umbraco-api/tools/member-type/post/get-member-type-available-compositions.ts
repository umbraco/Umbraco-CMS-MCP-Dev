import { postMemberTypeAvailableCompositionsBody, postMemberTypeAvailableCompositionsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { MemberTypeCompositionRequestModel } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
