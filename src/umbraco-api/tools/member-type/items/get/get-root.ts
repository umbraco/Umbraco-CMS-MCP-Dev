import { GetTreeMemberTypeRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMemberTypeRootQueryParams, getTreeMemberTypeRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
