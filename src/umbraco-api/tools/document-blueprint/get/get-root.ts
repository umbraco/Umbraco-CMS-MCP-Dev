import { GetTreeDocumentBlueprintRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDocumentBlueprintRootQueryParams, getTreeDocumentBlueprintRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
