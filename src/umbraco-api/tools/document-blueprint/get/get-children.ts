import { GetTreeDocumentBlueprintChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDocumentBlueprintChildrenQueryParams, getTreeDocumentBlueprintChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
