import { GetRelationTypeParams } from "@/umbraco-api/schemas/index.js";
import { getRelationTypeQueryParams, getRelationTypeResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
