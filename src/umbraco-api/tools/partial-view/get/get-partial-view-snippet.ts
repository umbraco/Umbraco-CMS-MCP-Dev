import { GetPartialViewSnippetParams } from "@/umbraco-api/schemas/index.js";
import { getPartialViewSnippetQueryParams, getPartialViewSnippetResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
