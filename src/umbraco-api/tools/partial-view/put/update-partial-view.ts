import { UpdatePartialViewRequestModel } from "@/umbraco-api/schemas/index.js";
import { putPartialViewByPathParams, putPartialViewByPathBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
