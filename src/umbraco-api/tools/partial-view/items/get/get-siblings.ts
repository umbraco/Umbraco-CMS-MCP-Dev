import { GetTreePartialViewSiblingsParams } from "@/umbraco-api/schemas/index.js";
import { getTreePartialViewSiblingsQueryParams, getTreePartialViewSiblingsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
