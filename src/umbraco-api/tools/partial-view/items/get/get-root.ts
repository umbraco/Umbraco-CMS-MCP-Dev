import { GetTreePartialViewRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreePartialViewRootQueryParams, getTreePartialViewRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
