import { GetTreePartialViewChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreePartialViewChildrenQueryParams, getTreePartialViewChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
