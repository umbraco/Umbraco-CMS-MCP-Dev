import { UpdateCurrentUserRequestModel } from "@/umbraco-api/schemas/updateCurrentUserRequestModel.js";
import { putUserCurrentProfileBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
