import { getDocumentByIdReferencedDescendantsParams, getDocumentByIdReferencedDescendantsQueryParams, getDocumentByIdReferencedDescendantsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
