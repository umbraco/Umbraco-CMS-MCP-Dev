import { getDocumentByIdReferencedByParams, getDocumentByIdReferencedByQueryParams, getDocumentByIdReferencedByResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
