import { getDocumentByIdPublicAccessParams, getDocumentByIdPublicAccessQueryParams, getDocumentByIdPublicAccessResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
