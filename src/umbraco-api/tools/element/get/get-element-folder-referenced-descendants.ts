import { getElementFolderByIdReferencedDescendantsParams, getElementFolderByIdReferencedDescendantsQueryParams, getElementFolderByIdReferencedDescendantsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
