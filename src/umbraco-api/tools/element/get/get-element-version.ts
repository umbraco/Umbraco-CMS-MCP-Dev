import { getElementVersionQueryParams, getElementVersionResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetElementVersionParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
