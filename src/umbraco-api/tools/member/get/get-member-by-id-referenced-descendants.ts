import { getMemberByIdReferencedDescendantsParams, getMemberByIdReferencedDescendantsQueryParams, getMemberByIdReferencedDescendantsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
