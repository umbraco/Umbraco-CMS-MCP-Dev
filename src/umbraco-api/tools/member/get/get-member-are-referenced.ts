import { getMemberAreReferencedQueryParams, getMemberAreReferencedResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetMemberAreReferencedParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
