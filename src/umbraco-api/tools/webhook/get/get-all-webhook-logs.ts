import { GetWebhookLogsParams } from "@/umbraco-api/schemas/index.js";
import { getWebhookLogsQueryParams, getWebhookLogsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
