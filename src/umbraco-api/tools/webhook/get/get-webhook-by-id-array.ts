import { GetItemWebhookParams } from "@/umbraco-api/schemas/index.js";
import { getItemWebhookQueryParams, getItemWebhookResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
