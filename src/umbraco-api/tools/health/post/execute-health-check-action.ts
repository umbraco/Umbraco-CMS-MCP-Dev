import { postHealthCheckExecuteActionBody, postHealthCheckExecuteActionResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { HealthCheckActionRequestModel } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
