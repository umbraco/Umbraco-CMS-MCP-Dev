import { getSearcherQueryParams, getSearcherResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetSearcherParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
