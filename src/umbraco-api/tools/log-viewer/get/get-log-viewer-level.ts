import { getLogViewerLevelQueryParams, getLogViewerLevelResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetLogViewerLevelParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
