import { getLogViewerSavedSearchQueryParams, getLogViewerSavedSearchResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetLogViewerSavedSearchParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
