import { getLogViewerLogQueryParams, getLogViewerLogResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetLogViewerLogParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
