import { getItemStaticFileQueryParams, getItemStaticFileResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetItemStaticFileParams } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
