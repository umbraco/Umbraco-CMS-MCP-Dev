import { getTreeStaticFileChildrenQueryParams, getTreeStaticFileChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetTreeStaticFileChildrenParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
