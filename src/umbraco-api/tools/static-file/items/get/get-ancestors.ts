import { getTreeStaticFileAncestorsQueryParams, getTreeStaticFileAncestorsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetTreeStaticFileAncestorsParams } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
