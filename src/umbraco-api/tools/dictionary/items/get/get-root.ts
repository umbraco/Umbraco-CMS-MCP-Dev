import { GetTreeDictionaryRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDictionaryRootQueryParams, getTreeDictionaryRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
