import { GetTreeDictionaryAncestorsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDictionaryAncestorsQueryParams, getTreeDictionaryAncestorsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
