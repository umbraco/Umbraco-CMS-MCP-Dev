import { GetDictionaryParams } from "@/umbraco-api/schemas/index.js";
import { getDictionaryQueryParams, getDictionaryResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
