import { TemplateQueryExecuteModel } from "@/umbraco-api/schemas/index.js";
import { postTemplateQueryExecuteBody, postTemplateQueryExecuteResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
