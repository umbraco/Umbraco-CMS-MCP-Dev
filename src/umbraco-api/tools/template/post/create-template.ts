...
import { CreateTemplateRequestModel, ProblemDetails } from "@/umbraco-api/schemas/index.js";
import { postTemplateBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
  createToolResult,
