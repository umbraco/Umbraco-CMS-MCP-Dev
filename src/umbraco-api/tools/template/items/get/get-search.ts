import { GetItemTemplateSearchParams } from "@/umbraco-api/schemas/index.js";
import { getItemTemplateSearchQueryParams, getItemTemplateSearchResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
