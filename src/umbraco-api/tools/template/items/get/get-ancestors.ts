import { GetTreeTemplateAncestorsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeTemplateAncestorsQueryParams, getTreeTemplateAncestorsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
