import { GetTreeTemplateSiblingsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeTemplateSiblingsQueryParams, getTreeTemplateSiblingsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
