import { GetTreeTemplateRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeTemplateRootQueryParams, getTreeTemplateRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
