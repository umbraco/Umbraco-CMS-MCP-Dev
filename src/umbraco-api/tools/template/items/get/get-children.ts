import { GetTreeTemplateChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeTemplateChildrenQueryParams, getTreeTemplateChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
