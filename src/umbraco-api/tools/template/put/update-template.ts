import { UpdateTemplateRequestModel } from "@/umbraco-api/schemas/index.js";
import { putTemplateByIdBody, putTemplateByIdParams } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
