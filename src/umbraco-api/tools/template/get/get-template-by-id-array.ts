import { GetItemTemplateParams } from "@/umbraco-api/schemas/index.js";
import { getItemTemplateQueryParams, getItemTemplateResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
