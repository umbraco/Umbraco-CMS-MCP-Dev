import { MoveMediaRequestModel } from "@/umbraco-api/schemas/index.js";
import { putMediaByIdMoveParams, putMediaByIdMoveBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
