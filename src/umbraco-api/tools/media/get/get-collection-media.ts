import { GetCollectionMediaParams } from "@/umbraco-api/schemas/index.js";
import { getCollectionMediaQueryParams, getCollectionMediaResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
