import { GetRecycleBinMediaReferencedByParams } from "@/umbraco-api/schemas/index.js";
import { getRecycleBinMediaReferencedByQueryParams, getRecycleBinMediaReferencedByResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
