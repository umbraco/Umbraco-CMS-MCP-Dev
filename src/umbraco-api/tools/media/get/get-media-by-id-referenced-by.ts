import { getMediaByIdReferencedByParams, getMediaByIdReferencedByQueryParams, getMediaByIdReferencedByResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
