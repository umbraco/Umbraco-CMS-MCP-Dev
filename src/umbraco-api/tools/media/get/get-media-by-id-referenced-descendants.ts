import { getMediaByIdReferencedDescendantsParams, getMediaByIdReferencedDescendantsQueryParams, getMediaByIdReferencedDescendantsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
