import { GetTreeMediaChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMediaChildrenQueryParams, getTreeMediaChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
