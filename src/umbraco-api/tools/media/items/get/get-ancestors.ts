import { GetTreeMediaAncestorsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMediaAncestorsQueryParams, getTreeMediaAncestorsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
