import { GetTreeMediaRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeMediaRootQueryParams, getTreeMediaRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
