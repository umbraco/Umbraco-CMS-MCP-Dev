...
import { postUserDataBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { CreateUserDataRequestModel, ProblemDetails } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
  createToolResult,
