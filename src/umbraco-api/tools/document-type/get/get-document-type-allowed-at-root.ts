import { getDocumentTypeAllowedAtRootQueryParams, getDocumentTypeAllowedAtRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetDocumentTypeAllowedAtRootParams } from "@/umbraco-api/schemas/index.js";
import {
  type ToolDefinition,
