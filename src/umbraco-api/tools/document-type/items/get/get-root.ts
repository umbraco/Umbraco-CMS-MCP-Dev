import { GetTreeDocumentTypeRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDocumentTypeRootQueryParams, getTreeDocumentTypeRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
