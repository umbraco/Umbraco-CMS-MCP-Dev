import { GetTreeDocumentTypeChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDocumentTypeChildrenQueryParams, getTreeDocumentTypeChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
