import { GetTreeDocumentTypeSiblingsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDocumentTypeSiblingsQueryParams, getTreeDocumentTypeSiblingsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
