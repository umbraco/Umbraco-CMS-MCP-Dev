import { GetDataTypeSchemasBatchParams } from "@/umbraco-api/schemas/index.js";
import { getDataTypeSchemasBatchQueryParams } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
