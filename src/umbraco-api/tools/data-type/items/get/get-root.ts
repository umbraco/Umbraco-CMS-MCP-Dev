import { GetTreeDataTypeRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDataTypeRootQueryParams, getTreeDataTypeRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
