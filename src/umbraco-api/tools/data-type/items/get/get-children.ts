import { GetTreeDataTypeChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeDataTypeChildrenQueryParams, getTreeDataTypeChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
