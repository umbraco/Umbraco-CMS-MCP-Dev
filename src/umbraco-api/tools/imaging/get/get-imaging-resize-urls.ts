import { getImagingResizeUrlsQueryParams, getImagingResizeUrlsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { GetImagingResizeUrlsParams } from "@/umbraco-api/schemas/index.js";
import { z } from "zod";
import {
  type ToolDefinition,
