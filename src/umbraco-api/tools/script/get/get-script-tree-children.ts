import { GetTreeScriptChildrenParams } from "@/umbraco-api/schemas/index.js";
import { getTreeScriptChildrenQueryParams, getTreeScriptChildrenResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
