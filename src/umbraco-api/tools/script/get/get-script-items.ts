import { GetItemScriptParams } from "@/umbraco-api/schemas/index.js";
import { getItemScriptQueryParams, getItemScriptResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
