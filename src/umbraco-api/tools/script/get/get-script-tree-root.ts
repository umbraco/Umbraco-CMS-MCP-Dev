import { GetTreeScriptRootParams } from "@/umbraco-api/schemas/index.js";
import { getTreeScriptRootQueryParams, getTreeScriptRootResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
