import { GetTreeScriptSiblingsParams } from "@/umbraco-api/schemas/index.js";
import { getTreeScriptSiblingsQueryParams, getTreeScriptSiblingsResponse } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import {
  type ToolDefinition,
