...
import { CreateScriptFolderRequestModel, ProblemDetails } from "@/umbraco-api/schemas/index.js";
import { postScriptFolderBody } from "@/umbraco-api/umbracoManagementAPI.zod.js";
import { z } from "zod";
import {
  type ToolDefinition,
  createToolResult,
